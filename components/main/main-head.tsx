  ...
  return (
    <div className="flex w-full flex-col items-center justify-center gap-7 md:flex-row md:items-start md:justify-between md:gap-10">
      <div className="w-full text-center md:text-left">
        <h1 className="text-dark flex flex-col text-[40px] font-bold leading-tight dark:text-white md:text-6xl">
          <span>Buy Memes.</span>
          <span>In Two Clicks.</span>
        </h1>
        <p className="text-dark mt-2 text-sm dark:text-white md:text-2xl">
          <span>The fastest way to buy memes in just two clicks.</span>
          <span className="block">
            Under 1 minute to sign up and no wallet needed
          </span>
        </p>
        <div className="mt-6 hidden w-full items-center justify-between gap-4 md:flex md:flex-col lg:flex-row">
          <div className="dark:bg-dark-150 text-dark w-full rounded-xl bg-[#f5f5f5] p-4 dark:text-white">
